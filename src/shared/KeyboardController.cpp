...
void KeyboardController::mapInputs()
{
	...
	inputs->brake = (m_keyboardState[DIK_LSHIFT]&0x80)?true:false;
	inputs->reverse = (m_keyboardState[DIK_S]&0x80)?true:false;
	inputs->reorient = (m_keyboardState[DIK_R]&0x80)?true:false;
